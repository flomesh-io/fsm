...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilterAncestorStatus) DeepCopyInto(out *FilterAncestorStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilterAncestorStatus.
func (in *FilterAncestorStatus) DeepCopy() *FilterAncestorStatus {
	if in == nil {
		return nil
	}
	out := new(FilterAncestorStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FilterStatus) DeepCopyInto(out *FilterStatus) {
	*out = *in
	if in.Ancestors != nil {
		...
		*out = make([]FilterAncestorStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
