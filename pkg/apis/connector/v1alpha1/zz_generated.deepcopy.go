...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataStrategy) DeepCopyInto(out *MetadataStrategy) {
	*out = *in
	if in.LabelConversions != nil {
		in, out := &in.LabelConversions, &out.LabelConversions
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.AnnotationConversions != nil {
		in, out := &in.AnnotationConversions, &out.AnnotationConversions
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataStrategy.
func (in *MetadataStrategy) DeepCopy() *MetadataStrategy {
	if in == nil {
		return nil
	}
	out := new(MetadataStrategy)
...
func (in *NacosAuthSpec) DeepCopyInto(out *NacosAuthSpec) {
	*out = *in
	if in.TokenExpireSeconds != nil {
		in, out := &in.TokenExpireSeconds, &out.TokenExpireSeconds
		*out = new(int32)
		**out = **in
	}
	return
