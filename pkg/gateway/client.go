...
func newClient(ctx *cctx.ControllerContext) *client {
	...
	informers := map[fsminformers.InformerKey]crClient.Object{
		...
		fsminformers.InformerKeyHealthCheckPolicyV1alpha1: &gwpav1alpha2.HealthCheckPolicy{},
		fsminformers.InformerKeyRetryPolicyV1alpha1:       &gwpav1alpha2.RetryPolicy{},
		...
		fsminformers.InformerKeyHTTPLog:                   &extv1alpha1.HTTPLog{},
	}
