...
func (p *TLSRoutesTrigger) Insert(obj interface{}, cache processor.Processor) bool {
...
func (p *TLSRoutesTrigger) Delete(obj interface{}, cache processor.Processor) bool {
	route, ok := obj.(*gwv1alpha2.TLSRoute)
	if !ok {
		log.Error().Msgf("unexpected object type %T", obj)
		return false
