...
func (p *TCPRoutesTrigger) Insert(obj interface{}, cache processor.Processor) bool {
...
func (p *TCPRoutesTrigger) Delete(obj interface{}, cache processor.Processor) bool {
	route, ok := obj.(*gwv1alpha2.TCPRoute)
	if !ok {
		log.Error().Msgf("unexpected object type %T", obj)
		return false
