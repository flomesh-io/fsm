...
func (p *GatewayClassesTrigger) Insert(obj interface{}, cache processor.Processor) bool {
...
func (p *GatewayClassesTrigger) Delete(obj interface{}, cache processor.Processor) bool {
	//class, ok := obj.(*gwv1.GatewayClass)
	//if !ok {
	//	log.Error().Msgf("unexpected object type %T", obj)
	//	return false
