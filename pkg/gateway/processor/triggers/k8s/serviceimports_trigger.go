...
func (p *ServiceImportsTrigger) Insert(obj interface{}, cache processor.Processor) bool {
...
func (p *ServiceImportsTrigger) Delete(obj interface{}, cache processor.Processor) bool {
	svcimp, ok := obj.(*mcsv1alpha1.ServiceImport)
	if !ok {
		log.Error().Msgf("unexpected object type %T", obj)
		return false
