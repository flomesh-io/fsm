...
func (p *CircuitBreakingPoliciesTrigger) Insert(obj interface{}, cache processor.Processor) bool {
...
func (p *CircuitBreakingPoliciesTrigger) Delete(obj interface{}, cache processor.Processor) bool {
	policy, ok := obj.(*gwpav1alpha1.CircuitBreakingPolicy)
	if !ok {
		log.Error().Msgf("unexpected object type %T", obj)
		return false
