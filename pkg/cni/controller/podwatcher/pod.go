...
func parsePodConfigFromAnnotations(annotations map[string]string, pod *podConfig) {
	statusPort := 15021
	if v, ok := annotations["flomesh.io/port"]; ok {
	...
	if v, ok := annotations["flomesh.io/inbound-port-exclusion-list"]; ok {
	...
	if v, ok := annotations["flomesh.io/outbound-port-exclusion-list"]; ok {
	...
	if v, ok := annotations["flomesh.io/inbound-port-inclusion-list"]; ok {
	...
	if v, ok := annotations["flomesh.io/outbound-port-inclusion-list"]; ok {
	...
	if v, ok := annotations["flomesh.io/outbound-ip-range-exclusion-list"]; ok {
	...
	if v, ok := annotations["flomesh.io/outbound-ip-range-inclusion-list"]; ok {
