...
func (c *listenerFilters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ListenerFilter, err error) {
	result = &v1alpha1.ListenerFilter{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("listenerfilters").
		Name(name).
...
func (c *listenerFilters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ListenerFilterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ListenerFilterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("listenerfilters").
...
func (c *listenerFilters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *listenerFilters) Create(ctx context.Context, listenerFilter *v1alpha1.ListenerFilter, opts v1.CreateOptions) (result *v1alpha1.ListenerFilter, err error) {
	result = &v1alpha1.ListenerFilter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("listenerfilters").
...
func (c *listenerFilters) Update(ctx context.Context, listenerFilter *v1alpha1.ListenerFilter, opts v1.UpdateOptions) (result *v1alpha1.ListenerFilter, err error) {
	result = &v1alpha1.ListenerFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("listenerfilters").
		Name(listenerFilter.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(listenerFilter).
		Do(ctx).
		Into(result)
...
func (c *listenerFilters) UpdateStatus(ctx context.Context, listenerFilter *v1alpha1.ListenerFilter, opts v1.UpdateOptions) (result *v1alpha1.ListenerFilter, err error) {
	result = &v1alpha1.ListenerFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("listenerfilters").
...
func (c *listenerFilters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *listenerFilters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *listenerFilters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ListenerFilter, err error) {
	result = &v1alpha1.ListenerFilter{}
