...
var httplogsResource = v1alpha1.SchemeGroupVersion.WithResource("httplogs")

var httplogsKind = v1alpha1.SchemeGroupVersion.WithKind("HTTPLog")
...
func (c *FakeHTTPLogs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HTTPLogList, err error) {
	...
	list := &v1alpha1.HTTPLogList{ListMeta: obj.(*v1alpha1.HTTPLogList).ListMeta}
	for _, item := range obj.(*v1alpha1.HTTPLogList).Items {
...
func (c *FakeHTTPLogs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(httplogsResource, c.ns, name, opts), &v1alpha1.HTTPLog{})
