...
func (c *hTTPLogs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HTTPLog, err error) {
	result = &v1alpha1.HTTPLog{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httplogs").
		Name(name).
...
func (c *hTTPLogs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HTTPLogList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HTTPLogList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httplogs").
...
func (c *hTTPLogs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hTTPLogs) Create(ctx context.Context, hTTPLog *v1alpha1.HTTPLog, opts v1.CreateOptions) (result *v1alpha1.HTTPLog, err error) {
	result = &v1alpha1.HTTPLog{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("httplogs").
...
func (c *hTTPLogs) Update(ctx context.Context, hTTPLog *v1alpha1.HTTPLog, opts v1.UpdateOptions) (result *v1alpha1.HTTPLog, err error) {
	result = &v1alpha1.HTTPLog{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httplogs").
...
func (c *hTTPLogs) UpdateStatus(ctx context.Context, hTTPLog *v1alpha1.HTTPLog, opts v1.UpdateOptions) (result *v1alpha1.HTTPLog, err error) {
	result = &v1alpha1.HTTPLog{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httplogs").
...
// Delete takes name of the hTTPLog and deletes it. Returns an error if one occurs.
func (c *hTTPLogs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hTTPLogs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hTTPLogs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HTTPLog, err error) {
	result = &v1alpha1.HTTPLog{}
