...
type ConcurrencyLimitLister interface {
	...
	List(selector labels.Selector) (ret []*extensionv1alpha1.ConcurrencyLimit, err error)
...
type concurrencyLimitLister struct {
	listers.ResourceIndexer[*extensionv1alpha1.ConcurrencyLimit]
}
...
func NewConcurrencyLimitLister(indexer cache.Indexer) ConcurrencyLimitLister {
	return &concurrencyLimitLister{listers.New[*extensionv1alpha1.ConcurrencyLimit](indexer, extensionv1alpha1.Resource("concurrencylimit"))}
}

// ConcurrencyLimits returns an object that can list and get ConcurrencyLimits.
func (s *concurrencyLimitLister) ConcurrencyLimits(namespace string) ConcurrencyLimitNamespaceLister {
	return concurrencyLimitNamespaceLister{listers.NewNamespaced[*extensionv1alpha1.ConcurrencyLimit](s.ResourceIndexer, namespace)}
}
...
type ConcurrencyLimitNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*extensionv1alpha1.ConcurrencyLimit, error)
