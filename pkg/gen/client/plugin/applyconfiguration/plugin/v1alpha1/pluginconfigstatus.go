...
// PluginConfigStatusApplyConfiguration represents an declarative configuration of the PluginConfigStatus type for use
// with apply.
...
// PluginConfigStatusApplyConfiguration constructs an declarative configuration of the PluginConfigStatus type for use with
// apply.
func PluginConfigStatus() *PluginConfigStatusApplyConfiguration {
	return &PluginConfigStatusApplyConfiguration{}
}
