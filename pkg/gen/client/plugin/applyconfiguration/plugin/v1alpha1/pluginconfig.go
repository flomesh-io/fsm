...
// PluginConfigApplyConfiguration represents an declarative configuration of the PluginConfig type for use
// with apply.
...
// PluginConfig constructs an declarative configuration of the PluginConfig type for use with
// apply.
func PluginConfig(name, namespace string) *PluginConfigApplyConfiguration {
	b := &PluginConfigApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("PluginConfig")
...
func (b *PluginConfigApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
