...
type PluginInterface interface {
	...
	Apply(ctx context.Context, plugin *pluginv1alpha1.PluginApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Plugin, err error)
	ApplyStatus(ctx context.Context, plugin *pluginv1alpha1.PluginApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Plugin, err error)
	PluginExpansion
}
...
func (c *plugins) Apply(ctx context.Context, plugin *pluginv1alpha1.PluginApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Plugin, err error) {
	if plugin == nil {
...
func (c *plugins) ApplyStatus(ctx context.Context, plugin *pluginv1alpha1.PluginApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Plugin, err error) {
	if plugin == nil {
		return nil, fmt.Errorf("plugin provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
