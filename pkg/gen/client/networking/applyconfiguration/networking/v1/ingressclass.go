...
type IngressClassApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *networkingv1.IngressClassSpec `json:"spec,omitempty"`
}
...
func (b *IngressClassApplyConfiguration) WithSpec(value networkingv1.IngressClassSpec) *IngressClassApplyConfiguration {
	b.Spec = &value
	return b
}
