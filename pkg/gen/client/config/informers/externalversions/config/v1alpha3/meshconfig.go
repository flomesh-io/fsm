...
import (
	...
	apisconfigv1alpha3 "github.com/flomesh-io/fsm/pkg/apis/config/v1alpha3"
	...
	configv1alpha3 "github.com/flomesh-io/fsm/pkg/gen/client/config/listers/config/v1alpha3"
...
type MeshConfigInformer interface {
	...
	Lister() configv1alpha3.MeshConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigV1alpha3().MeshConfigs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1alpha3().MeshConfigs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1alpha3().MeshConfigs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1alpha3().MeshConfigs(namespace).Watch(ctx, options)
			},
		},
		&apisconfigv1alpha3.MeshConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *meshConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisconfigv1alpha3.MeshConfig{}, f.defaultInformer)
}

func (f *meshConfigInformer) Lister() configv1alpha3.MeshConfigLister {
	return configv1alpha3.NewMeshConfigLister(f.Informer().GetIndexer())
}
