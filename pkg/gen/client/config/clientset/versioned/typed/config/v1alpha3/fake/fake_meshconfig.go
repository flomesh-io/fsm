...
func (c *FakeMeshConfigs) Apply(ctx context.Context, meshConfig *configv1alpha3.MeshConfigApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha3.MeshConfig, err error) {
	if meshConfig == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(meshconfigsResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha3.MeshConfig{})
