...
var meshconfigsResource = schema.GroupVersionResource{Group: "config.flomesh.io", Version: "v1alpha2", Resource: "meshconfigs"}

var meshconfigsKind = schema.GroupVersionKind{Group: "config.flomesh.io", Version: "v1alpha2", Kind: "MeshConfig"}
