...
var meshconfigsResource = v1alpha2.SchemeGroupVersion.WithResource("meshconfigs")

var meshconfigsKind = v1alpha2.SchemeGroupVersion.WithKind("MeshConfig")
...
func (c *FakeMeshConfigs) Apply(ctx context.Context, meshConfig *configv1alpha2.MeshConfigApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.MeshConfig, err error) {
	if meshConfig == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(meshconfigsResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha2.MeshConfig{})
