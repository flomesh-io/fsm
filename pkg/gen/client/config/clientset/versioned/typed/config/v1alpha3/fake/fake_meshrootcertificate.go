...
func (c *FakeMeshRootCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.MeshRootCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(meshrootcertificatesResource, c.ns, name), &v1alpha3.MeshRootCertificate{})
...
func (c *FakeMeshRootCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.MeshRootCertificateList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(meshrootcertificatesResource, meshrootcertificatesKind, c.ns, opts), &v1alpha3.MeshRootCertificateList{})
...
func (c *FakeMeshRootCertificates) Create(ctx context.Context, meshRootCertificate *v1alpha3.MeshRootCertificate, opts v1.CreateOptions) (result *v1alpha3.MeshRootCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(meshrootcertificatesResource, c.ns, meshRootCertificate), &v1alpha3.MeshRootCertificate{})
...
func (c *FakeMeshRootCertificates) Update(ctx context.Context, meshRootCertificate *v1alpha3.MeshRootCertificate, opts v1.UpdateOptions) (result *v1alpha3.MeshRootCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(meshrootcertificatesResource, c.ns, meshRootCertificate), &v1alpha3.MeshRootCertificate{})
...
func (c *FakeMeshRootCertificates) UpdateStatus(ctx context.Context, meshRootCertificate *v1alpha3.MeshRootCertificate, opts v1.UpdateOptions) (*v1alpha3.MeshRootCertificate, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(meshrootcertificatesResource, "status", c.ns, meshRootCertificate), &v1alpha3.MeshRootCertificate{})
