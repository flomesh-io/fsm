...
var meshrootcertificatesResource = v1alpha2.SchemeGroupVersion.WithResource("meshrootcertificates")

var meshrootcertificatesKind = v1alpha2.SchemeGroupVersion.WithKind("MeshRootCertificate")
...
func (c *FakeMeshRootCertificates) Apply(ctx context.Context, meshRootCertificate *configv1alpha2.MeshRootCertificateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.MeshRootCertificate, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(meshrootcertificatesResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha2.MeshRootCertificate{})
...
func (c *FakeMeshRootCertificates) ApplyStatus(ctx context.Context, meshRootCertificate *configv1alpha2.MeshRootCertificateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.MeshRootCertificate, err error) {
	if meshRootCertificate == nil {
		return nil, fmt.Errorf("meshRootCertificate provided to Apply must not be nil")
	}
	data, err := json.Marshal(meshRootCertificate)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(meshrootcertificatesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1alpha2.MeshRootCertificate{})
