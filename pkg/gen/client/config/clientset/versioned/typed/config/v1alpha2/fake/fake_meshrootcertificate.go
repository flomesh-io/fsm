...
var meshrootcertificatesResource = schema.GroupVersionResource{Group: "config.flomesh.io", Version: "v1alpha2", Resource: "meshrootcertificates"}

var meshrootcertificatesKind = schema.GroupVersionKind{Group: "config.flomesh.io", Version: "v1alpha2", Kind: "MeshRootCertificate"}
