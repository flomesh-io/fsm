...
// VaultTokenSpecApplyConfiguration represents an declarative configuration of the VaultTokenSpec type for use
// with apply.
...
// VaultTokenSpecApplyConfiguration constructs an declarative configuration of the VaultTokenSpec type for use with
// apply.
func VaultTokenSpec() *VaultTokenSpecApplyConfiguration {
	return &VaultTokenSpecApplyConfiguration{}
}
