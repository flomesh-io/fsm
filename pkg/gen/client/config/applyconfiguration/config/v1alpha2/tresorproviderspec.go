...
// TresorProviderSpecApplyConfiguration represents an declarative configuration of the TresorProviderSpec type for use
// with apply.
type TresorProviderSpecApplyConfiguration struct {
	CA *TresorCASpecApplyConfiguration `json:"ca,omitempty"`
}

// TresorProviderSpecApplyConfiguration constructs an declarative configuration of the TresorProviderSpec type for use with
// apply.
func TresorProviderSpec() *TresorProviderSpecApplyConfiguration {
	return &TresorProviderSpecApplyConfiguration{}
}
