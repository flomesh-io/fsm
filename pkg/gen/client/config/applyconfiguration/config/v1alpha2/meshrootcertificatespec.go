...
// MeshRootCertificateSpecApplyConfiguration represents an declarative configuration of the MeshRootCertificateSpec type for use
// with apply.
...
// MeshRootCertificateSpecApplyConfiguration constructs an declarative configuration of the MeshRootCertificateSpec type for use with
// apply.
func MeshRootCertificateSpec() *MeshRootCertificateSpecApplyConfiguration {
	return &MeshRootCertificateSpecApplyConfiguration{}
}
