...
// MeshRootCertificateApplyConfiguration represents an declarative configuration of the MeshRootCertificate type for use
// with apply.
...
// MeshRootCertificate constructs an declarative configuration of the MeshRootCertificate type for use with
// apply.
func MeshRootCertificate(name, namespace string) *MeshRootCertificateApplyConfiguration {
	b := &MeshRootCertificateApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("MeshRootCertificate")
	b.WithAPIVersion("config.flomesh.io/v1alpha2")
	return b
}
...
func (b *MeshRootCertificateApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
