...
func (c *FakeTrafficSplits) UpdateStatus(ctx context.Context, trafficSplit *v1alpha1.TrafficSplit, opts v1.UpdateOptions) (result *v1alpha1.TrafficSplit, err error) {
	emptyResult := &v1alpha1.TrafficSplit{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(trafficsplitsResource, "status", c.ns, trafficSplit, opts), emptyResult)
