...
import (
	v1alpha1 "github.com/flomesh-io/fsm/pkg/gen/client/traffic/clientset/versioned/typed/traffic/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeTrafficV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeTrafficV1alpha1) RESTClient() rest.Interface {
