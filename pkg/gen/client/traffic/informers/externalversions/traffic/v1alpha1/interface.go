...
type Interface interface {
	// HTTPTrafficRules returns a HTTPTrafficRuleInformer.
	HTTPTrafficRules() HTTPTrafficRuleInformer
...
// HTTPTrafficRules returns a HTTPTrafficRuleInformer.
func (v *version) HTTPTrafficRules() HTTPTrafficRuleInformer {
	return &hTTPTrafficRuleInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
