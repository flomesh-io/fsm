...
type IngressBackendInterface interface {
	...
	Apply(ctx context.Context, ingressBackend *policyv1alpha1.IngressBackendApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IngressBackend, err error)
	ApplyStatus(ctx context.Context, ingressBackend *policyv1alpha1.IngressBackendApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IngressBackend, err error)
...
func (c *ingressBackends) Apply(ctx context.Context, ingressBackend *policyv1alpha1.IngressBackendApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IngressBackend, err error) {
...
func (c *ingressBackends) ApplyStatus(ctx context.Context, ingressBackend *policyv1alpha1.IngressBackendApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IngressBackend, err error) {
	if ingressBackend == nil {
		return nil, fmt.Errorf("ingressBackend provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
