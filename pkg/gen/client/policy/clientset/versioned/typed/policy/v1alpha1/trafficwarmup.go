...
// TrafficWarmupsGetter has a method to return a TrafficWarmupInterface.
// A group's client should implement this interface.
type TrafficWarmupsGetter interface {
	TrafficWarmups(namespace string) TrafficWarmupInterface
}
