...
type HTTPRouteSpecApplyConfiguration struct {
	...
	RateLimit *HTTPPerRouteRateLimitSpecApplyConfiguration `json:"rateLimit,omitempty"`
}
...
func (b *HTTPRouteSpecApplyConfiguration) WithPath(value string) *HTTPRouteSpecApplyConfiguration {
	b.Path = &value
	return b
}
...
func (b *HTTPRouteSpecApplyConfiguration) WithRateLimit(value *HTTPPerRouteRateLimitSpecApplyConfiguration) *HTTPRouteSpecApplyConfiguration {
	b.RateLimit = value
	return b
}
