...
type IngressBackendInformer interface {
	...
	Lister() policyv1alpha1.IngressBackendLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1alpha1().IngressBackends(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().IngressBackends(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().IngressBackends(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().IngressBackends(namespace).Watch(ctx, options)
			},
		},
		&apispolicyv1alpha1.IngressBackend{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ingressBackendInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apispolicyv1alpha1.IngressBackend{}, f.defaultInformer)
}

func (f *ingressBackendInformer) Lister() policyv1alpha1.IngressBackendLister {
	return policyv1alpha1.NewIngressBackendLister(f.Informer().GetIndexer())
}
