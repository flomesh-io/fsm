...
type EgressLister interface {
	...
	List(selector labels.Selector) (ret []*policyv1alpha1.Egress, err error)
...
type egressLister struct {
	listers.ResourceIndexer[*policyv1alpha1.Egress]
}

// NewEgressLister returns a new EgressLister.
func NewEgressLister(indexer cache.Indexer) EgressLister {
	return &egressLister{listers.New[*policyv1alpha1.Egress](indexer, policyv1alpha1.Resource("egress"))}
}

// Egresses returns an object that can list and get Egresses.
func (s *egressLister) Egresses(namespace string) EgressNamespaceLister {
	return egressNamespaceLister{listers.NewNamespaced[*policyv1alpha1.Egress](s.ResourceIndexer, namespace)}
}
...
type EgressNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*policyv1alpha1.Egress, error)
