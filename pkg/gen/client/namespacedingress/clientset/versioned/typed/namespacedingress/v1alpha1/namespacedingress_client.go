...
// NetworkingV1alpha1Client is used to interact with features provided by the networking.flomesh.io group.
type NetworkingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NetworkingV1alpha1Client) NamespacedIngresses(namespace string) NamespacedIngressInterface {
