...
import (
	...
	"github.com/flomesh-io/fsm/pkg/gen/client/machine/clientset/versioned/scheme"
...
// MachineV1alpha1Client is used to interact with features provided by the machine.flomesh.io group.
type MachineV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MachineV1alpha1Client) VirtualMachines(namespace string) VirtualMachineInterface {
