...
import (
	...
	connector "github.com/flomesh-io/fsm/pkg/gen/client/connector/informers/externalversions/connector"
...
func (f *sharedInformerFactory) Connector() connector.Interface {
	return connector.New(f, f.namespace, f.tweakListOptions)
}
