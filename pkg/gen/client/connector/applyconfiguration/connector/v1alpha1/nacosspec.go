...
func (b *NacosSpecApplyConfiguration) WithSyncPeriod(value v1.Duration) *NacosSpecApplyConfiguration {
	b.SyncPeriod = &value
	return b
}
...
func (b *NacosSpecApplyConfiguration) WithResources(value corev1.ResourceRequirements) *NacosSpecApplyConfiguration {
	b.Resources = &value
	return b
}
...
func (b *NacosSpecApplyConfiguration) WithReplicas(value int32) *NacosSpecApplyConfiguration {
	b.Replicas = &value
	return b
}
