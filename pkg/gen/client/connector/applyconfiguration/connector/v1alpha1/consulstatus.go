...
// apply.
func ConsulStatus() *ConsulStatusApplyConfiguration {
	return &ConsulStatusApplyConfiguration{}
}
...
func (b *ConsulStatusApplyConfiguration) WithCurrentStatus(value string) *ConsulStatusApplyConfiguration {
