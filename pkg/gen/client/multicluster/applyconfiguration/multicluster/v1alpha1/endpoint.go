...
func (b *EndpointApplyConfiguration) WithTarget(value *TargetApplyConfiguration) *EndpointApplyConfiguration {
	b.Target = value
	return b
}
...
func (b *EndpointApplyConfiguration) WithClusterKey(value string) *EndpointApplyConfiguration {
	b.ClusterKey = &value
	return b
}
