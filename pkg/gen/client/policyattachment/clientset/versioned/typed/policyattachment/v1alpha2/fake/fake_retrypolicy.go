...
var retrypoliciesResource = v1alpha2.SchemeGroupVersion.WithResource("retrypolicies")

var retrypoliciesKind = v1alpha2.SchemeGroupVersion.WithKind("RetryPolicy")
...
func (c *FakeRetryPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.RetryPolicyList, err error) {
	...
	list := &v1alpha2.RetryPolicyList{ListMeta: obj.(*v1alpha2.RetryPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha2.RetryPolicyList).Items {
...
func (c *FakeRetryPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(retrypoliciesResource, c.ns, name, opts), &v1alpha2.RetryPolicy{})
