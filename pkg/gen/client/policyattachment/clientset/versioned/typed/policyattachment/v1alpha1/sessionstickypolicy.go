...
type SessionStickyPolicyInterface interface {
	...
	Apply(ctx context.Context, sessionStickyPolicy *policyattachmentv1alpha1.SessionStickyPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.SessionStickyPolicy, err error)
	ApplyStatus(ctx context.Context, sessionStickyPolicy *policyattachmentv1alpha1.SessionStickyPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.SessionStickyPolicy, err error)
...
func (c *sessionStickyPolicies) Apply(ctx context.Context, sessionStickyPolicy *policyattachmentv1alpha1.SessionStickyPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.SessionStickyPolicy, err error) {
...
func (c *sessionStickyPolicies) ApplyStatus(ctx context.Context, sessionStickyPolicy *policyattachmentv1alpha1.SessionStickyPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.SessionStickyPolicy, err error) {
	if sessionStickyPolicy == nil {
		return nil, fmt.Errorf("sessionStickyPolicy provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
