...
var upstreamtlspoliciesResource = v1alpha1.SchemeGroupVersion.WithResource("upstreamtlspolicies")

var upstreamtlspoliciesKind = v1alpha1.SchemeGroupVersion.WithKind("UpstreamTLSPolicy")
...
func (c *FakeUpstreamTLSPolicies) Apply(ctx context.Context, upstreamTLSPolicy *policyattachmentv1alpha1.UpstreamTLSPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.UpstreamTLSPolicy, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(upstreamtlspoliciesResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.UpstreamTLSPolicy{})
...
func (c *FakeUpstreamTLSPolicies) ApplyStatus(ctx context.Context, upstreamTLSPolicy *policyattachmentv1alpha1.UpstreamTLSPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.UpstreamTLSPolicy, err error) {
	if upstreamTLSPolicy == nil {
		return nil, fmt.Errorf("upstreamTLSPolicy provided to Apply must not be nil")
	}
	data, err := json.Marshal(upstreamTLSPolicy)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(upstreamtlspoliciesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1alpha1.UpstreamTLSPolicy{})
