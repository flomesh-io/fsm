...
type GatewayTLSPolicyInterface interface {
	...
	Apply(ctx context.Context, gatewayTLSPolicy *policyattachmentv1alpha1.GatewayTLSPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.GatewayTLSPolicy, err error)
	ApplyStatus(ctx context.Context, gatewayTLSPolicy *policyattachmentv1alpha1.GatewayTLSPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.GatewayTLSPolicy, err error)
...
func (c *gatewayTLSPolicies) Apply(ctx context.Context, gatewayTLSPolicy *policyattachmentv1alpha1.GatewayTLSPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.GatewayTLSPolicy, err error) {
...
func (c *gatewayTLSPolicies) ApplyStatus(ctx context.Context, gatewayTLSPolicy *policyattachmentv1alpha1.GatewayTLSPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.GatewayTLSPolicy, err error) {
	if gatewayTLSPolicy == nil {
		return nil, fmt.Errorf("gatewayTLSPolicy provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
