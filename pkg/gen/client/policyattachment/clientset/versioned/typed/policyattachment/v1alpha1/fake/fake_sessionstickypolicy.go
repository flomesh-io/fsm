...
var sessionstickypoliciesResource = v1alpha1.SchemeGroupVersion.WithResource("sessionstickypolicies")

var sessionstickypoliciesKind = v1alpha1.SchemeGroupVersion.WithKind("SessionStickyPolicy")
