...
func newHealthCheckPolicies(c *GatewayV1alpha1Client, namespace string) *healthCheckPolicies {
...
func (c *healthCheckPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HealthCheckPolicy, err error) {
...
func (c *healthCheckPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HealthCheckPolicyList, err error) {
...
func (c *healthCheckPolicies) Create(ctx context.Context, healthCheckPolicy *v1alpha1.HealthCheckPolicy, opts v1.CreateOptions) (result *v1alpha1.HealthCheckPolicy, err error) {
	result = &v1alpha1.HealthCheckPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("healthcheckpolicies").
...
func (c *healthCheckPolicies) Update(ctx context.Context, healthCheckPolicy *v1alpha1.HealthCheckPolicy, opts v1.UpdateOptions) (result *v1alpha1.HealthCheckPolicy, err error) {
	result = &v1alpha1.HealthCheckPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("healthcheckpolicies").
...
func (c *healthCheckPolicies) UpdateStatus(ctx context.Context, healthCheckPolicy *v1alpha1.HealthCheckPolicy, opts v1.UpdateOptions) (result *v1alpha1.HealthCheckPolicy, err error) {
	result = &v1alpha1.HealthCheckPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("healthcheckpolicies").
...
func (c *healthCheckPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HealthCheckPolicy, err error) {
	result = &v1alpha1.HealthCheckPolicy{}
