...
func (c *GatewayV1alpha2Client) RouteRuleFilterPolicies(namespace string) RouteRuleFilterPolicyInterface {
	return newRouteRuleFilterPolicies(c, namespace)
}
