...
type RetryPolicySpecApplyConfiguration struct {
	...
	Ports         []PortRetryApplyConfiguration   `json:"ports,omitempty"`
	DefaultConfig *RetryConfigApplyConfiguration  `json:"config,omitempty"`
}
...
func (b *RetryPolicySpecApplyConfiguration) WithTargetRef(value v1alpha2.PolicyTargetReference) *RetryPolicySpecApplyConfiguration {
	b.TargetRef = &value
	return b
}
...
func (b *RetryPolicySpecApplyConfiguration) WithPorts(values ...*PortRetryApplyConfiguration) *RetryPolicySpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *RetryPolicySpecApplyConfiguration) WithDefaultConfig(value *RetryConfigApplyConfiguration) *RetryPolicySpecApplyConfiguration {
