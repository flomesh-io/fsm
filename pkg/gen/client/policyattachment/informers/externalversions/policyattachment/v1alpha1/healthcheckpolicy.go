	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV1alpha1().HealthCheckPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV1alpha1().HealthCheckPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&policyattachmentv1alpha1.HealthCheckPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *healthCheckPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyattachmentv1alpha1.HealthCheckPolicy{}, f.defaultInformer)
}
