...
type AccessControlLister interface {
	...
	List(selector labels.Selector) (ret []*xnetworkv1alpha1.AccessControl, err error)
...
type accessControlLister struct {
	listers.ResourceIndexer[*xnetworkv1alpha1.AccessControl]
}
...
func NewAccessControlLister(indexer cache.Indexer) AccessControlLister {
	return &accessControlLister{listers.New[*xnetworkv1alpha1.AccessControl](indexer, xnetworkv1alpha1.Resource("accesscontrol"))}
}

// AccessControls returns an object that can list and get AccessControls.
func (s *accessControlLister) AccessControls(namespace string) AccessControlNamespaceLister {
	return accessControlNamespaceLister{listers.NewNamespaced[*xnetworkv1alpha1.AccessControl](s.ResourceIndexer, namespace)}
}
...
type AccessControlNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*xnetworkv1alpha1.AccessControl, error)
