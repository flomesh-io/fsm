...
const (
	...
	GatewayAPIIPRestriction             ResourceType = "GatewayAPI(IPRestriction)"
	GatewayAPIExternalRateLimit         ResourceType = "GatewayAPI(ExternalRateLimit)"
	GatewayAPIRequestTermination        ResourceType = "GatewayAPI(RequestTermination)"
	GatewayAPIConcurrencyLimit          ResourceType = "GatewayAPI(ConcurrencyLimit)"
