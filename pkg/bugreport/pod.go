...
func getPerPodCommands(pod types.NamespacedName) [][]string {
	return [][]string{
		...
		{"fsm", "proxy", "get", "config_dump", pod.Name, "-n", pod.Namespace},
		{"fsm", "proxy", "get", "ready", pod.Name, "-n", pod.Namespace},
		{"fsm", "proxy", "get", "stats", pod.Name, "-n", pod.Namespace},
		{"fsm", "proxy", "get", "clusters", pod.Name, "-n", pod.Namespace},
		{"fsm", "proxy", "get", "listeners", pod.Name, "-n", pod.Namespace},
		{"fsm", "proxy", "get", "certs", pod.Name, "-n", pod.Namespace},
	}
}
