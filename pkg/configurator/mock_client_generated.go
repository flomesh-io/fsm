...
// IsGracefulExitUntilDownstreamEnds mocks base method.
func (m *MockConfigurator) IsGracefulExitUntilDownstreamEnds() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsGracefulExitUntilDownstreamEnds")
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsGracefulExitUntilDownstreamEnds indicates an expected call of IsGracefulExitUntilDownstreamEnds.
func (mr *MockConfiguratorMockRecorder) IsGracefulExitUntilDownstreamEnds() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsGracefulExitUntilDownstreamEnds", reflect.TypeOf((*MockConfigurator)(nil).IsGracefulExitUntilDownstreamEnds))
}
