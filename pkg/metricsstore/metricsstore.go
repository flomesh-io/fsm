...
// Ex: fsm_<metric-name>
const metricsRootNamespace = "fsm"
...
func init() {
	...
	defaultMetricsStore.ProxyConnectCount = prometheus.NewGauge(prometheus.GaugeOpts{
		...
		Subsystem: "proxy",
		Name:      "connect_count",
		Help:      "Represents the number of proxies connected to FSM controller",
	})
	...
	defaultMetricsStore.ProxyReconnectCount = prometheus.NewCounter(prometheus.CounterOpts{
		...
		Help:      "Represents the number of reconnects from known proxies to FSM controller",
	})
	...
	defaultMetricsStore.ProxyBroadcastEventCount = prometheus.NewCounter(prometheus.CounterOpts{
		...
		Help:      "Represents the number of ProxyBroadcast events published by the FSM controller",
	})
	...
	defaultMetricsStore.ErrCodeCounter = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			...
			Subsystem: "error",
			Name:      "err_code_count",
			Help:      "Respesents the number of errcodes generated by FSM",
		},
		[]string{"err_code"},
	)
	...
	defaultMetricsStore.VersionInfo = prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: metricsRootNamespace,
		Name:      "version_info",
		Help:      "Contains the static information denoting the version of this FSM instance",
