...
const (
	...
	ValidatingWebhookName = "fsm-validator.k8s.io"

	// ValidatorWebhookSvc is the name of the validator service.
	ValidatorWebhookSvc = "fsm-validator"
)

func createOrUpdateValidatingWebhook(clientSet kubernetes.Interface, cert *certificate.Certificate, webhookName, meshName, fsmNamespace, fsmVersion string, validateTrafficTarget bool, enableReconciler bool) error {
