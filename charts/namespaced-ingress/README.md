...
![Version: 1.2.0-beta.3](https://img.shields.io/badge/Version-1.2.0--beta.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.2.0-beta.3](https://img.shields.io/badge/AppVersion-1.2.0--beta.3-informational?style=flat-square)
...
| fsm.image.tag | string | `"1.2.0-beta.3"` | Container image tag for control plane images |
