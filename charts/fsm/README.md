...
| fsm.fsmXnetwork.xnet.image.tag | string | `"1.5.1"` | xnet image tag |
...
| fsm.repoServer | object | `{"codebase":"","image":{"name":"pipy-repo","registry":"flomesh","tag":"1.5.12"},"ipaddr":"127.0.0.1","port":6060,"standalone":false}` | Pipy RepoServer |
...
| fsm.repoServer.image.tag | string | `"1.5.12"` | Repo server image tag |
...
| fsm.sidecar | object | `{"compressConfig":true,"gracefulExitUntilDownstreamEnds":true,"holdApplicationUntilProxyStarts":true,"image":{"name":"pipy","registry":"flomesh","tag":"1.5.12"},"sidecarDisabledMTLS":false,"sidecarLogLevel":"error","sidecarTimeout":60}` | Sidecar supported by fsm |
...
| fsm.sidecar.image.tag | string | `"1.5.12"` | Sidecar image tag |
