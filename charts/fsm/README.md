...
| fsm.repoServer | object | `{"codebase":"","image":{"name":"pipy-repo","registry":"flomesh","tag":"1.4.3"},"ipaddr":"127.0.0.1","port":6060,"standalone":false}` | Pipy RepoServer |
...
| fsm.repoServer.image.tag | string | `"1.4.3"` | Repo server image tag |
...
| fsm.sidecar | object | `{"image":{"name":"pipy","registry":"flomesh","tag":"1.4.3"},"sidecarDisabledMTLS":false,"sidecarLogLevel":"error","sidecarTimeout":60}` | Sidecar supported by fsm |
...
| fsm.sidecar.image.tag | string | `"1.4.3"` | Sidecar image tag |
