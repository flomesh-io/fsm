...
| fsm.repoServer | object | `{"codebase":"","image":{"name":"pipy-repo","registry":"flomesh","tag":"1.5.2"},"ipaddr":"127.0.0.1","port":6060,"standalone":false}` | Pipy RepoServer |
...
| fsm.repoServer.image.tag | string | `"1.5.2"` | Repo server image tag |
...
| fsm.sidecar | object | `{"compressConfig":true,"image":{"name":"pipy","registry":"flomesh","tag":"1.5.2"},"sidecarDisabledMTLS":false,"sidecarLogLevel":"error","sidecarTimeout":60}` | Sidecar supported by fsm |
...
| fsm.sidecar.image.tag | string | `"1.5.2"` | Sidecar image tag |
