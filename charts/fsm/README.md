...
![Version: 1.5.0-alpha.9](https://img.shields.io/badge/Version-1.5.0--alpha.9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.5.0-alpha.9](https://img.shields.io/badge/AppVersion-v1.5.0--alpha.9-informational?style=flat-square)
...
| fsm.fsmXnetwork.xnet.image.tag | string | `"1.5.0-alpha.9"` | xnet image tag |
