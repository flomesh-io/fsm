...
![Version: 1.5.0-alpha.10](https://img.shields.io/badge/Version-1.5.0--alpha.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.5.0-alpha.10](https://img.shields.io/badge/AppVersion-v1.5.0--alpha.10-informational?style=flat-square)
...
| fsm.fsmXnetwork.xnet.image.tag | string | `"1.5.0-alpha.10"` | xnet image tag |
...
| fsm.image.tag | string | `"1.5.0-alpha.10"` | Container image tag for control plane images |
