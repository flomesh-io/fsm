...
![Version: 1.4.8](https://img.shields.io/badge/Version-1.4.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.4.8](https://img.shields.io/badge/AppVersion-v1.4.8-informational?style=flat-square)
...
| fsm.image.tag | string | `"1.4.8"` | Container image tag for control plane images |
...
| fsm.repoServer | object | `{"codebase":"","image":{"name":"pipy-repo","registry":"flomesh","tag":"1.5.4"},"ipaddr":"127.0.0.1","port":6060,"standalone":false}` | Pipy RepoServer |
...
| fsm.repoServer.image.tag | string | `"1.5.4"` | Repo server image tag |
...
| fsm.sidecar | object | `{"compressConfig":true,"image":{"name":"pipy","registry":"flomesh","tag":"1.5.4"},"sidecarDisabledMTLS":false,"sidecarLogLevel":"error","sidecarTimeout":60}` | Sidecar supported by fsm |
...
| fsm.sidecar.image.tag | string | `"1.5.4"` | Sidecar image tag |
