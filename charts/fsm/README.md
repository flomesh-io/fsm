...
![Version: 1.2.6-alpha.1](https://img.shields.io/badge/Version-1.2.6--alpha.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.2.6-alpha.1](https://img.shields.io/badge/AppVersion-v1.2.6--alpha.1-informational?style=flat-square)
...
| fsm.image.tag | string | `"1.2.6-alpha.1"` | Container image tag for control plane images |
...
| fsm.repoServer | object | `{"codebase":"","image":{"name":"pipy-repo","registry":"flomesh","tag":"1.1.0-1"},"ipaddr":"127.0.0.1","port":6060,"standalone":false}` | Pipy RepoServer |
...
| fsm.repoServer.image.tag | string | `"1.1.0-1"` | Repo server image tag |
...
| fsm.sidecar.image.tag | string | `"1.1.0-1"` | Sidecar image tag |
