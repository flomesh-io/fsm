...
![Version: 1.2.1-alpha.6](https://img.shields.io/badge/Version-1.2.1--alpha.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.2.1-alpha.6](https://img.shields.io/badge/AppVersion-v1.2.1--alpha.6-informational?style=flat-square)
...
| fsm.cloudConnector.gateway.ingress.ipSelector | string | `"ExternalIP"` |  |
...
| fsm.image.tag | string | `"1.2.1-alpha.6"` | Container image tag for control plane images |
...
| fsm.sidecar | object | `{"enabled":true,"image":{"name":"pipy","registry":"flomesh","tag":"0.99.1-1"},"sidecarDisabledMTLS":false,"sidecarLogLevel":"error","sidecarTimeout":60}` | Sidecar supported by fsm |
| fsm.sidecar.enabled | bool | `true` | Sidecar is enabled or not, it implies if service mesh is enabled |
