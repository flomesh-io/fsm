...
![Version: 1.2.7](https://img.shields.io/badge/Version-1.2.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.2.7](https://img.shields.io/badge/AppVersion-v1.2.7-informational?style=flat-square)
...
| fsm.image.tag | string | `"1.2.7"` | Container image tag for control plane images |
