...
![Version: 1.4.20-alpha.1](https://img.shields.io/badge/Version-1.4.20--alpha.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.4.20-alpha.1](https://img.shields.io/badge/AppVersion-v1.4.20--alpha.1-informational?style=flat-square)
...
| fsm.image.tag | string | `"1.4.20-alpha.1"` | Container image tag for control plane images |
...
| fsm.sidecar | object | `{"compressConfig":true,"image":{"name":"pipy","registry":"flomesh","tag":"1.5.10"},"sidecarDisabledMTLS":false,"sidecarLogLevel":"error","sidecarTimeout":60}` | Sidecar supported by fsm |
