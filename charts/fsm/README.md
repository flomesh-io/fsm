...
| fsm.sidecar | object | `{"compressConfig":true,"gracefulExitUntilDownstreamEnds":true,"holdApplicationUntilProxyStarts":true,"httpResponseBufferSize":1,"image":{"name":"pipy","registry":"flomesh","tag":"1.5.18"},"sidecarDisabledMTLS":false,"sidecarLogLevel":"error","sidecarTimeout":60}` | Sidecar supported by fsm |
...
| fsm.sidecar.httpResponseBufferSize | int | `1` | Response bytes buffered before HTTP/1.x switches to chunked transfer encoding |
