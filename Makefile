...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) crd:allowDangerousTypes=true,deprecatedV1beta1CompatibilityPreserveUnknownFields=false paths="./pkg/apis/..." output:crd:artifacts:config=cmd/fsm-bootstrap/crds
...
>>>>>>> 658c056 (fix(security): Helm issue (#1036))
