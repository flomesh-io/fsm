			...
			namespaces: []*corev1.Namespace{
				{
					ObjectMeta: metav1.ObjectMeta{
						...
						Labels: map[string]string{
							constants.FSMKubeResourceMonitorAnnotation: "my-mesh",
						},
					},
				},
			},
			...
			namespaces: []*corev1.Namespace{
				{
					ObjectMeta: metav1.ObjectMeta{
						Name: "ns1",
						Labels: map[string]string{
							constants.FSMKubeResourceMonitorAnnotation: "my-mesh1",
						},
					},
				},
				{
					ObjectMeta: metav1.ObjectMeta{
						Name: "ns2",
						Labels: map[string]string{
							constants.FSMKubeResourceMonitorAnnotation: "my-mesh2",
						},
					},
				},
			},
